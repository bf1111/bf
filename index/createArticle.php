    ...
    <div class="blog-masthead">
        <div class="container">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li>
                    <a class="blog-nav-item" href="/bf/index/create_article.php">写文章</a>
                </li>
                <li>
        ...
        <div class="row">
            ...
            <div class="col-sm-8 blog-main">
                <form action="add_article.php" method="POST">
                    ...
                    <div class="form-group">
                        <label>内容</label>
                        <textarea id="content" style="height:400px;max-height:500px;" name="cont" class="form-control" placeholder="这里是内容"></textarea>
                    </div>
